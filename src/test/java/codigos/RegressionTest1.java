...
public class RegressionTest1 {
    ...
    public void test0516() throws Throwable {
        ...
        codigos.ContaCorrente contaCorrente2 = new codigos.ContaCorrente(100.0f, 68.0f);
    }
    ...
    public void test0532() throws Throwable {
        ...
        float float20 = pedido0.calculaTaxaDesconto(false, "codigos.LadoInvalidoException: codigos.LadoInvalidoException: codigos.LadoInvalidoException: ", (float) (byte) 0);
        org.junit.Assert.assertTrue("'" + float4 + "' != '" + 10.0f + "'", float4 == 10.0f);
        org.junit.Assert.assertTrue("'" + float8 + "' != '" + 0.0f + "'", float8 == 0.0f);
        org.junit.Assert.assertTrue("'" + float12 + "' != '" + 0.0f + "'", float12 == 0.0f);
        org.junit.Assert.assertTrue("'" + float16 + "' != '" + 0.0f + "'", float16 == 0.0f);
    ...
    public void test0567() throws Throwable {
        ...
        float float8 = pedido0.calculaTaxaDesconto(false, "codigos.LadoInvalidoException: codigos.LadoInvalidoException: codigos.LadoInvalidoException: ", (float) 3);
    ...
    public void test0661() throws Throwable {
        ...
        codigos.Pedido pedido0 = new codigos.Pedido();
        float float4 = pedido0.calculaTaxaDesconto(true, "codigos.LadoInvalidoException: ", 1.0f);
        float float8 = pedido0.calculaTaxaDesconto(true, "codigos.LadoInvalidoException: codigos.LadoInvalidoException: codigos.LadoInvalidoException: ", (float) 1);
        org.junit.Assert.assertTrue("'" + float4 + "' != '" + 10.0f + "'", float4 == 10.0f);
        org.junit.Assert.assertTrue("'" + float8 + "' != '" + 10.0f + "'", float8 == 10.0f);
    }
    ...
    public void test0807() throws Throwable {
        ...
        float float16 = pedido0.calculaTaxaDesconto(true, "ESCALENO", (float) 2);
        float float20 = pedido0.calculaTaxaDesconto(false, "", (float) (byte) 100);
        float float24 = pedido0.calculaTaxaDesconto(true, "codigos.LadoInvalidoException: codigos.LadoInvalidoException: ", 3.0f);
        org.junit.Assert.assertTrue("'" + float4 + "' != '" + 10.0f + "'", float4 == 10.0f);
        org.junit.Assert.assertTrue("'" + float8 + "' != '" + 0.0f + "'", float8 == 0.0f);
        org.junit.Assert.assertTrue("'" + float12 + "' != '" + 0.0f + "'", float12 == 0.0f);
        org.junit.Assert.assertTrue("'" + float16 + "' != '" + 10.0f + "'", float16 == 10.0f);
    ...
    public void test0839() throws Throwable {
        ...
        codigos.ContaCorrente contaCorrente2 = new codigos.ContaCorrente((float) 3, (-32.0f));
    }
    ...
    public void test0932() throws Throwable {
        ...
        codigos.ContaCorrente contaCorrente2 = new codigos.ContaCorrente((float) 10L, (float) 2);
    }
    ...
    public void test0947() throws Throwable {
        ...
        codigos.ContaCorrente contaCorrente2 = new codigos.ContaCorrente((float) (short) 0, (float) 'a');
    }
    ...
    public void test0981() throws Throwable {
        ...
        contaCorrente2.setLimite(0.0f);
        contaCorrente2.setSaldo((float) '#');
        float float13 = contaCorrente2.saque(1.0f);
        org.junit.Assert.assertTrue("'" + float3 + "' != '" + 100.0f + "'", float3 == 100.0f);
        org.junit.Assert.assertTrue("'" + float13 + "' != '" + 34.0f + "'", float13 == 34.0f);
    }
